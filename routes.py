...
loaded_model = keras.models.load_model('fashion_mnist_model.h5') # Define the class names
...
@app.route('/predict', methods=['POST'])
 def predict(): file = request.files['file'] # get the file
    ...
    prediction = predict_image(image) return render_template('prediction.html', prediction=prediction)
